...
@media (max-width: 480px) {
    ...
    <script>
        // Function to get today's date and set it as default in the input
        window.onload = function() {
            const today = new Date().toISOString().split('T')[0]; // Format date as YYYY-MM-DD
            document.getElementById('date').value = today;
        };

        // Function to add a new food item input field dynamically at the top
function addFoodItem() {
    ...
    foodItemDiv.innerHTML = `
        <div class="food-item-field">
            <input type="text" placeholder="Food Item" class="food-item-input">
            <button class="remove-food-field" onclick="removeFoodField(this)">❌</button>
        </div>
    `;
    
    // Prepend the new food item at the top
    foodItemContainer.insertBefore(foodItemDiv, foodItemContainer.firstChild);
}

        // Function to remove a specific field of a food item
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="food-form">
            <!-- Date Input -->
            <form action="SaveFoodData" method="post" enctype="multipart/form-data">
            <label for="date">Date:</label>
            <input type="date" id="date" name="date" class="food-item-input" required>

            <!-- Food Items Container -->
            <div id="food-items">
                <!-- Default food item fields -->
                <div class="food-item">
                    <div class="food-item-field">
                        <input type="text" name="food_item" placeholder="Food Item" class="food-item-input">
                        <button class="remove-food-field" onclick="removeFoodField(this)">❌</button>
                    </div>
                    <div class="food-item-field">
                        <input type="text" name="description" placeholder="Description" class="food-item-input">
                    </div>
                    <div class="food-item-field">
                        <input type="text" name="address" placeholder="Address" class="food-item-input">
                    </div>
                    <div class="food-item-field">
                        <input type="text" name="name" placeholder="Donor's Name" class="food-item-input">
                    </div>
                    <div class="food-item-field">
                        <input type="tel" name="mobileno" placeholder="Mobile Number" class="food-item-input">
                    </div>
                    <div class="food-item-field">
                        <input type="file" name="file1" id="photo" accept="image/*" class="food-item-input">
                    </div>
                </div>
            </div>
