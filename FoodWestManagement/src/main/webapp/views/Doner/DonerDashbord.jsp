...
<body>
    ...
    <div class="sidebar">
        <div class="profile">
            <img src="${Doner_model.photo}" class="profile-img">
             <h2>OM KAlE</h2>
          </div>
    ...
    <header>
        <h1 class="user-header">Welcome ${Doner_model.name} to Your Dashboard</h1>
    </header>
    ...
    <div class="main-content">
        <div class="stats-container">
            <div class="stat-box">
                ...
                <p id="total-orders-placed">50</p>
            </div>
            <div class="stat-box">
                <h3>Pending Orders</h3>
                <p id="pending-orders">5</p>
            </div>
            <div class="stat-box">
                <h3>Completed Orders</h3>
                <p id="completed-orders">45</p>
            </div>
            <div class="stat-box">
                <h3>Active Deliveries</h3>
                <p id="active-deliveries">3</p>
            </div>
            <div class="stat-box">
                <h3>Requests Awaiting Confirmation</h3>
                <p id="requests-awaiting-confirmation">2</p>
            </div>
        </div>
    </div>
