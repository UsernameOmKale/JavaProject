...
<head>
    ...
    <title>partner Login - Food Waste Management System</title>
  <style type="text/css">
  /* Global Styles */
body {
    margin: 0;
...
<body>
    ...
    <div class="container">
        ...
        <p class="text-center">Don't have an account? <a href="PartnerReg">Register here</a></p>
    </div>
