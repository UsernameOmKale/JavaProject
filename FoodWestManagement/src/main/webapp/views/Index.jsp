...
<body>
    ...
    <header>
        ...
        <p>Reducing waste, promoting sustainability, and protecting our planet.</p>
        <nav>
            <div class="toggle-btns" id="admin-toggle">
                <a href="#" class="cta-btn">Admin Section</a>
                <div id="admin-options" class="toggle-options">
                    <a href="AdminLogin" class="cta-btn">Login</a>
                    <a href="AdminReg" class="cta-btn">Register</a>
                </div>
            </div>

            <div class="toggle-btns" id="user-toggle">
                <a href="#" class="cta-btn">Doner Section</a>
                <div id="user-options" class="toggle-options">
                    <a href="DonerLogin" class="cta-btn">Login</a>
                    <a href="DonerReg" class="cta-btn">Register</a>
                </div>
            </div>

            <div class="toggle-btns" id="partner-toggle">
                <a href="#" class="cta-btn">Delivery Partner</a>
                <div id="partner-options" class="toggle-options">
                    <a href="PartnerLogin" class="cta-btn">Login</a>
                    <a href="PartnerReg" class="cta-btn">Register</a>
                </div>
            </div>
        </nav>
    </header>
    ...
    <!-- Main Content -->
    <div class="container">
        <h2>Welcome to Our Food Waste Management System</h2>
        <p class="intro-text">
            Our platform is dedicated to reducing food waste and promoting sustainable practices for both households and businesses. Join us in making a positive impact on the environment by managing food waste effectively.
        </p>
        <a href="#get-started" class="cta-btn">Get Started</a>
    </div>

    <!-- Else-Out Hover Effect Section -->
    <div class="else-out-container">
        <h3>Why Choose Us?</h3>
        <p>
            Our system offers comprehensive food waste tracking and solutions to ensure that food is being used efficiently. We collaborate with individuals, businesses, and partners to reduce waste and encourage sustainability.
        </p>
        <a href="#else-out" class="else-out-btn">Learn More</a>
    </div>
