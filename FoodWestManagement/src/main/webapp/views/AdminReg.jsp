            ...
            if (!valid) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        event.target.submit(); // Submit the form after SweetAlert confirmation
                    }
                });
            }
        }
...
<body>
    ...
    <header>
        ...
        <p>Fill out the form below to create an admin account.</p>
    </header>

    <!-- Registration Form Section -->
    <div class="container">
        <form action="AdminSaveData" method="post" class="form">
